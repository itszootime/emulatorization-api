...
public class Sobol {
	...
	public static List<AnalysisOutputResult> run(List<Input> inputs, List<Output> outputs, String serviceURL, String processIdentifier, boolean plot, int designSize, int numBoot, double confidenceLevel) throws DesignException, ProcessEvaluatorException, SobolException {
	...
	public static List<AnalysisOutputResult> run(Emulator emulator, boolean plot, int designSize, int numBoot, double confidenceLevel) throws DesignException, EmulatorEvaluatorException, SobolException {
