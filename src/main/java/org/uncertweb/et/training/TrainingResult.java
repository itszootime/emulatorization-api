...
public class TrainingResult {
	...
	public TrainingResult(double[] predictedMean, double[] predictedCovariance, Design design, ProcessEvaluationResult evaluationResult, double[] lengthScales, Double nuggetVariance) {
